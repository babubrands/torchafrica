...
Enable **Authentication > Providers > Google** in Supabase. Add your Vercel URL and local test URL to the allowed redirect URLs when you deploy:
...
The current setup uses Google sign-in. Members can create and delete their own posts/comments. Approved admins can moderate all content. The owner account `ebarasa203@gmail.com` can approve future admin requests.
